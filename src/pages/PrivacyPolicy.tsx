        ...
        <div className="container py-12 md:py-16">
          ...
          >
            ...
            <section className="mb-8">
              ...
              <p>
                Los terceros que reciban datos (agencias, brokers, etc.) deberán cumplir con estándares equivalentes de seguridad y firmar acuerdos de confidencialidad y protección de datos.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Usamos cookies propias y de terceros para autenticación, preferencias y analítica. 
                El banner de cookies permite aceptar, rechazar o configurar las categorías. Para más detalle, véase nuestra Política de Cookies.
              </p>
              <p>
