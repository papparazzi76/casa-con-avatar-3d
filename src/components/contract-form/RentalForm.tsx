      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card className="border-2 shadow">
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              {landlords.map((landlord, index) => <RentalPartyFields key={`landlord-${index}`} which="landlord" party={landlord} index={index} parties={landlords} onPartyChange={handlePartyChange} onRemoveParty={removeParty} />)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 shadow">
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              {tenants.map((tenant, index) => <RentalPartyFields key={`tenant-${index}`} which="tenant" party={tenant} index={index} parties={tenants} onPartyChange={handlePartyChange} onRemoveParty={removeParty} />)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 shadow">
          <CardContent className="pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField control={form.control} name="inmueble" render={({
              field
              ...
              <FormField control={form.control} name="referencia_catastral" render={({
              field
            }) => <FormItem>
              ...
              <FormField control={form.control} name="fecha_firma" render={({
              field
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar mode="single" selected={field.value ? new Date(field.value) : undefined} onSelect={date => field.onChange(date ? format(date, "yyyy-MM-dd") : undefined)} initialFocus />
                      </PopoverContent>
                    </Popover>
                    <FormMessage />
                  </FormItem>} />

              <FormField control={form.control} name="poblacion_firma" render={({
              field
        ...
        <Card className="border-2 shadow">
          <CardContent className="pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField control={form.control} name="duracion" render={({
              field
            }) => <FormItem className={missingFields?.includes("duracion") ? "border-red-500 border-l-2 pl-2" : ""}>
                    <FormLabel>Duración (años)</FormLabel>
                    <FormControl>
                      <Input type="number" placeholder="5" min="1" max="5" {...field} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : undefined)} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              <FormField control={form.control} name="renta_mensual" render={({
              field
            }) => <FormItem className={missingFields?.includes("renta_mensual") ? "border-red-500 border-l-2 pl-2" : ""}>
                    <FormLabel>Renta Mensual (€)</FormLabel>
                    <FormControl>
                      <Input type="number" placeholder="750" {...field} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : undefined)} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              <FormField control={form.control} name="fecha_inicio_posesion" render={({
              field
              ...
              <FormField control={form.control} name="fecha_fin_posesion" render={({
              field
              ...
              <FormField control={form.control} name="fianza" render={({
              field
                    ...
                    <FormControl>
                      <Input type="number" placeholder={contractType.includes("amueblado") ? "2" : "1"} min="1" {...field} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : undefined)} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              <FormField control={form.control} name="cuenta_pago" render={({
              field
            }) => <FormItem>
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3">
                  <FormField control={form.control} name="gastos_luz" render={({
                  field
                  ...
                  <FormField control={form.control} name="gastos_agua" render={({
                  field
                }) => <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} />
                  ...
                  <FormField control={form.control} name="gastos_gas" render={({
                  field
                }) => <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} />
                  ...
                  <FormField control={form.control} name="gastos_internet" render={({
                  field
                }) => <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} />
                ...
                <FormField control={form.control} name="otros_gastos" render={({
                field
              ...
              {contractType.includes("amueblado") && <FormField control={form.control} name="inventario_muebles" render={({
              field
            }) => <FormItem className="md:col-span-2">
                      <FormLabel>Inventario de Mobiliario (Anexo I)</FormLabel>
                      <FormControl>
                        <Textarea rows={6} placeholder="Ej.: 1. Sofá 3 plazas – Ikea – Buen estado&#10;2. TV 42&quot; – LG – Muy buen estado&#10;..." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />}

              {/* Acta de estado inicial para viviendas sin amueblar */}
              {contractType.includes("sin_amueblar") && <div className="md:col-span-2 space-y-4">
                  <FormLabel className="text-base font-medium">ANEXO I – Acta de Estado Inicial</FormLabel>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="obs_pintura" render={({
                  field
                }) => <FormItem>
                    ...
                    <FormField control={form.control} name="obs_ventanas" render={({
                  field
                }) => <FormItem>
                    ...
                    <FormField control={form.control} name="obs_suelos" render={({
                  field
                }) => <FormItem>
                    ...
                    <FormField control={form.control} name="obs_electricidad" render={({
                  field
                }) => <FormItem>
                    ...
                    <FormField control={form.control} name="obs_agua" render={({
                  field
                }) => <FormItem>
                    ...
                    <FormField control={form.control} name="obs_otros" render={({
                  field
                }) => <FormItem>
              ...
              {/* Cláusulas adicionales */}
              <FormField control={form.control} name="clausulas_adicionales" render={({
              field
            }) => <FormItem className="md:col-span-2">
        ...
        {missingFields && missingFields.length > 0 && <div className="bg-red-50 text-red-700 p-4 rounded-md border border-red-200">
