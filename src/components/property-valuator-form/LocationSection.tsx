...
export function LocationSection({
  ...
  return <div className="space-y-4">
      ...
      <FormField control={form.control} name="zona_idealista" render={({
      field
    }) => <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              ...
              <SelectContent>
                {availableZones.map(zona => <SelectItem key={zona} value={zona}>
                    {zona}
                  </SelectItem>)}
              </SelectContent>
            </Select>
            <FormDescription>Barrios o distritos de Valladolid capital.</FormDescription>
            <FormMessage />
          </FormItem>} />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <FormField control={form.control} name="localidad" render={({
        field
      }) => <FormItem>
        ...
        <FormField control={form.control} name="distrito" render={({
        field
      }) => <FormItem>
